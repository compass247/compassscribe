...
(function () {
  ...
  const go = (id) => window.agewellScrollTo(id);
          ...
          <div className="team-grid">
            {u.team.map((m, i) => (
              <Reveal key={i} className="team-card" delay={i * 90}>
                {m.img
                  ? <img src={(window.__resources && window.__resources["team" + i]) || m.img} alt={m.title} className="team-photo" />
  ...
  function SignupForm({ t }) {
    ...
    const submit = (ev) => {
      ev.preventDefault();
      setTouched(true);
      if (nameOk && phoneOk) setDone(true);
    };
          ...
          <div className="form-wrap">
            {done ? (
              ...
              <form onSubmit={submit} noValidate>
                ...
                <button type="submit" className="btn btn-primary btn-lg" style={{ width: "100%" }}>{f.submit}</button>
        ...
        <div className="container">
          <div className="footer-top">
            <div className="footer-brand">
              <span className="logo-pill"><img src={(window.__resources && window.__resources.logoWhite) || "assets/logo-white.png"} alt="Compass AgeWell" /></span>
  ...
  Object.assign(window, { UspTeam, Eligibility, Testimonials, SignupForm, Footer, ContactBar });
})();
