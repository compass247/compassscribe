...
- **CNAME record**: trỏ tên → **một tên khác** (vd `compassscribe.com → agewell-alb-xxx.elb.amazonaws.com`).
...
```
   compassscribe.com ──CNAME──▶ agewell-alb-xxx.elb.amazonaws.com ──▶ (IP thật, AWS tự quản)
```
